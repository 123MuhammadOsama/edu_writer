...
function Scrollsection() {
  return (
    <div className=" md:mx-auto flex flex-col lg:justify-center lg:items-center lg:w-[1000px] xl:w-full w-fit  ">
      <div className="flex flex-col mt-8  justify-center lg:items-center ">
        <h2 className=" md:text-[28px] text-[26px] font-bold text-textColor  pb-2  tracking-wide leading-relaxed  text-center flex-wrap md:w-[700px] xl:w-[900px] w-full">
          Redefining Excellence with
          <span className="text-secondaryRed">  Assignment </span>,
          <span className="text-primaryBlue">  CourseWork</span>  and Essay Help!
        </h2>
      ...
      <div className="flex justify-between items-center w-full xl:w-[90%]">

        <ScrollArea className="md:h-[800px] h-[400px] border-t-2 border-b-2 border-b-secondaryRed border-t-secondaryRed px-2 my-10 mx-auto shadow-inner shadow-gray-300  lg:w-[2000px] md:w-[700px] xl:w-[87%] w-[300px] ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mx-1 mt-6">
            <div >
              <div className="flex flex-row py-1 gap-1">
                <div className="h-7 w-5 bg-tertiaryYellow rounded-r-full"></div>
                <h3 className="text-[23px] font-bold font-sans">
                  Professional <span className="text-secondaryRed">Assignment Writing </span>  Service UK with a Personal Touch
                </h3>
              ...
              <div className="flex flex-row py-1 gap-1">
                <div className="h-7 w-5 bg-tertiaryYellow rounded-r-full"></div>
                <h3 className="font-sans font-bold text-[23px] "> <span className="text-secondaryRed"> Round-the-Clock</span> Support That Keeps You Calm and Collected</h3>
              </div>
              <p className="mt-2 text-[16px]">
                We get it. Academic challenges can arise at any given moment. That &apos; s why our dedicated team is always available to listen to your requests, answer your questions, and offer guidance whenever you need it. Whether it&apos;s late-night panic over a looming deadline or a quick question about formatting, we're here to provide the support and peace of mind you need to navigate your academic journey with confidence.
              </p>
              ...
              <div className="flex flex-row py-2 gap-1 text-center justify-center items-center italic ">

                <h2 className="font-sans font-bold text-[26px] underline decoration-tertiaryYellow text-transparent bg-clip-text bg-gradient-to-r to-black via-secondaryRed from-Mahroon decoration-4 ">Turning Requests Into Results: Our Effortless Process</h2>
              </div>
              <p className="mt-2 text-[16px]">
                <span className="text-4xl font-bold font-serif">W</span>e &apos;ve streamlined the process to make your student life as easy as possible. From the moment you reach out to us to the point where you&apos;re confidently submitting your finished assignment, we ensure everything flows seamlessly. Here&apos;s how it works:
              </p>

              <ul className="list-disc pl-6 mt-4 space-y-2 text-[16px]">
                <li><span className="font-semibold">Tell Us What You Need:</span> Whether it&apos;s an assignment, a dissertation, or you simply want someone to pay to write your essay all you have to do is fill out our easy-to-navigate form with the details—no confusion, just clarity. You can also hit us up through our communication channels like the Chatbot, WhatsApp, or Email. We&aposre here to listen to your needs, so stress-free from the start. Yep, that&apos;s us!
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="flex flex-row py-2 gap-1 text-center justify-center items-center italic ">
                ...
                <h2 className="font-sans font-bold text-[26px] underline decoration-tertiaryYellow text-transparent bg-clip-text bg-gradient-to-r to-black via-secondaryRed from-Mahroon decoration-4 ">Why Choose Us for Stress-Free Assignment & Essay Writing Services?
                </h2>
              </div>
              <p className="mt-2 text-[16px]">
              ...
              <div className="flex flex-row py-2 gap-1">
                {/* <div className="h-7 w-4 bg-tertiaryYellow rounded-r-full"></div>
