...
const Academic7 = () => {
    ...
    const challenges = [
        {
          title: "Stuck on “I Don’t Even Know Where to Start!”",
          description: [
        ...
        {
            title: "Research That’s Exhausting and Never-Ending",
            description: [
        ...
        {
          title: "MaTime Constraints Are Crushing You",
          description: [
            ...
            "The best online case study assignment help ensure you meet your deadlines without breaking a sweat. Whether you’re hours or days away from submission, we guarantee your content will be factual, engaging, and easy to follow—delivering a paper that leaves a lasting impression. Plus, we handle urgent requests without compromising on quality. So, why even worry? Trust us and set yourself up for success!"
          ]
        },
        {
          title: "Overwhelmed by Complex Analytical Methods",
          description: [
