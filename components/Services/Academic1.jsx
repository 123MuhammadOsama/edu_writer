...
const Academic1 = () => {
    ...
    const challenges = [
        {
          title: "Overwhelmed by Endless Deadlines? Let’s Take the Load Off!",
          description: [
        ...
        {
            title: "Stuck on Tough Topics? We’ve Got the Experts!",
            description: [
        ...
        {
          title: "Finding Sources a Nightmare? We’ve Got It Covered!",
          description: [
        ...
        {
          title: "Facing Writer’s Block? Let Us Do the Writing!",
          description: [
        ...
        {
          title: "Struggling with Formatting? Leave It to Us!",
          description: [
