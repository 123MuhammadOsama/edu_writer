  ...
  const challenges = [
    {
      title: (
        <>
          Tackling Complex <span className="text-red-600">Research Topics</span>? We Make It Easy!
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Lack of <span className="text-red-600">Research Skills</span>? We’ve Got the Expertise!
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Managing Time Amid <span className="text-red-600">Tight Deadlines</span>? Let Us Take Over!
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Writing Isn’t Your <span className="text-red-600">Strong Suit</span>? We’ll Handle It!
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Formatting and <span className="text-red-600">Citation Nightmares</span>? Consider It Done!
        </>
      ),
      description: [
