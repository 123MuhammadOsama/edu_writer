...
const Academic2 = () => {
    ...
    const challenges = [
        {
          title: "Overwhelmed by the Research Process? Let’s Take the Reins!",
          description: [
        ...
        {
            title: "Struggling to Find a Unique Topic? We’ll Help You Shine!",
            description: [
        ...
        {
          title: "Can’t Seem to Structure Your Dissertation? We’ll Sort It Out!",
          description: [
        ...
        {
          title: "Writer’s Block Holding You Back? Let’s Get You Unstuck!",
          description: [
        ...
        {
          title: "Trouble Meeting Multiple Deadlines? Count On Us!",
          description: [
