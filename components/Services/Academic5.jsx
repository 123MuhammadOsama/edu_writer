  ...
  const challenges = [
    {
      title: (
        <>
          Struggling with <span className="text-red-600">Complex Topics</span>? Let Our Experts Simplify It for You
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Running Out of Time? Let Us Meet Your <span className="text-red-600">Deadline</span> Stress-Free
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Finding <span className="text-red-600">Research</span> Exhausting? We’re Here to Do the Heavy Lifting
        </>
      ),
      description: [
        ...
        "That’s where the best coursework writing help comes to the rescue. We do all the legwork, from deep research to expertly crafted arguments. You’ll receive a masterpiece that’s well-researched, well-structured, and reflective of the latest academic standards. All you have to do is review it and see if it's to your liking! So, why wait any longer? Save yourself time and mental strain—let EduWriters.UK take on the research burden for you!"
      ]
    },
    {
      title: (
        <>
          Unsure of <span className="text-red-600">Formatting</span> and Citation Styles? Leave That to Us
        </>
      ),
      description: [
    ...
    },
    {
      title: (
        <>
          Lack Confidence in Your <span className="text-red-600">Writing Skills</span>? We’ll Polish Your Work
        </>
      ),
      description: [
        "Maybe writing isn’t your strong suit, or perhaps you’re just struggling with the specific tone and style required for academic coursework. Either way, weak writing can undermine even the most well-researched paper. But don’t worry—our writing experts are here to help.",
