...
const Academic8 = () => {
    ...
    const challenges = [
        {
          title: "Spotting Mistakes, a Challenge? Let’s Catch What You Miss",
          description: [
        ...
        {
            title: "Facing Grammar Troubles? We’re Here to Fix Every Slip",
            description: [
        ...
        {
          title: "Struggle to Maintain Consistency? Time to Ditch Awkward Transitions",
          description: [
        ...
        {
          title: "Running Out of Time and Patience? Relax, We’ve Got This Covered",
          description: [
        ...
        {
          title: "Lack Confidence in Writing? Let Experts Bring Out Your Best",
          description: [
